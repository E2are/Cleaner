...
Shader "Shadero Customs/card_appear"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Desintegration_Value_1("_Desintegration_Value_1", Range(0, 1)) = 0
_Desintegration_Speed_1("_Desintegration_Speed_1", Range(0, 1)) = 0.6660236
_RGBA_Mul_Fade_1("_RGBA_Mul_Fade_1", Range(0, 2)) = 1.003843
...
float4 _Desintegration_1 = DesintegrationFX(_MainTex_1,i.texcoord,_Desintegration_Value_1,_Desintegration_Speed_1);
_Desintegration_1.rgb *= _RGBA_Mul_Fade_1;
